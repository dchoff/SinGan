...
class Generator(nn.Module):
    def __init__(self, img_size_min, num_scale, scale_factor=4/3, injection_scale=0):
        ...
        self.size_list = [int(self.img_size_min * scale_factor**(i+injection_scale)) for i in range(num_scale + 1)]
